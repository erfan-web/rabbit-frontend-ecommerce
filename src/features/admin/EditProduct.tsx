...
import { colors, sizes } from "@/shared/lib/constants/filterdata";
...
const EditProduct = () => {
  ...
  const handleImageUpload = async (e: ChangeEvent<HTMLInputElement>) => {
    ...
    if (!file.type.startsWith("image/")) {
      console.error("UPLOAD ERROR: Only image files are allowed");
      return;
    }
    if (file.size > 5 * 1024 * 1024) {
      console.error("UPLOAD ERROR: Image must be smaller than 5MB");
      return;
    }
