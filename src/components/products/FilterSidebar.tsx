...
import { brands, categories, colors, gender, materials, sizes } from "../../lib/constants/filterdata";
...
const FilterSidebar = () => {
  ...
  const handleFilterChange = (
    ...
    if (target instanceof HTMLInputElement && target.type === "checkbox") {
      if (target.checked) {
        newFilters[name] = [...(newFilters[name] as string[]), value];
      } else {
        newFilters[name] = (newFilters[name] as string[]).filter(
          (item) => item !== value
        );
      }
